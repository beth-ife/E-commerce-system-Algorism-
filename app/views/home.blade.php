...
<div class="content">
    <div class="container">
        <div class="content-top">
            ...
            <!--            if($products->isEmpty())
                        <p>Oops! No Products In the store at the moment</p>
                        else-->
                ...
                <div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="/product_{{$product->id}}">
                            <img class="img-responsive item_thumb" src="images/{{$product->image}}" alt="" />
                        </a>
                        <h3 class="item_name"><a href="/product_{{$product->id}}">{{$product->title}}</a></h3>
                        <h3 style="display: none;" class="item_id">{{$product->id}}</h3>
